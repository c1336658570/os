...
![截图 2023-06-11 19-08-58](./截图 2023-06-11 19-08-58.png)
...
![截图 2023-06-11 19-39-32](./截图 2023-06-11 19-39-32.png)
...
![截图 2023-06-11 19-58-04](./截图 2023-06-11 19-58-04.png)端口可以被分为两组，Command Block registers 和 Control Block registers。Command Block registers用于向硬盘驱动器写入命令字或者从硬盘控制器获得硬盘状态，Control Block registers 用于控制硬盘工作状态。在 Control Block registers 组中的寄存器已经精减了，而且咱们基本上用不到，不说它们了，下面重点介绍 Command Block registers 组中的寄存器。
...
![截图 2023-06-11 20-33-03](./截图 2023-06-11 20-33-03.png)
