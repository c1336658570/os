...
//连续比较以地址a_和地址b_开头的size个字节，若想等则返回0，a_大于b_，返回+1，否则返回-1
...
//比较两个字符串，若a_中的字符大于b_中的字符，返回1,想等返回0,否则返回-1
int8_t strcmp(const char *a, const char *b) {
  ...
  //在后面的布尔表达式"*a > *b"中，若*a大于*b，表达式就等于1，否则表达式不成立，也就是布尔值为0，恰恰表示*a等于*b
  return *a < *b ? -1 : *a > *b;
}
